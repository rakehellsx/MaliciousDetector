...
void MemoryImagePage::refreshData()
{
    ...
    if (m_loader && m_loader->isLoaded()) {
        ...
        data = loadLatestResult("memory_image");
    ...
    if (data.isEmpty()) {
        QString jsonStr =
            ...
            "\"used_physical_mb\":6348,"
            "\"used_percent\":38.7,"
            "\"available_physical_mb\":10036,"
            "\"virtual_memory_mb\":32768,"
            "\"page_file\":\"C:/pagefile.sys (2048 MB)\","
            "\"kernel_modules\":["
            "{\"name\":\"ntoskrnl.exe\",\"base_address\":\"0xFFFFF80000000000\",\"image_size\":\"8.2 MB\",\"flags\":\"0x0\",\"index\":1,\"path\":\"C:/Windows/System32/ntoskrnl.exe\",\"is_trusted\":true},"
            "{\"name\":\"hal.dll\",\"base_address\":\"0xFFFFF80001200000\",\"image_size\":\"0.5 MB\",\"flags\":\"0x0\",\"index\":2,\"path\":\"C:/Windows/System32/hal.dll\",\"is_trusted\":true},"
            "{\"name\":\"hiddrv.sys\",\"base_address\":\"0xFFFFF88003A00000\",\"image_size\":\"0.1 MB\",\"flags\":\"0x4\",\"index\":87,\"path\":\"C:/Windows/System32/drivers/hiddrv.sys\",\"is_trusted\":false},"
            "{\"name\":\"win32k.sys\",\"base_address\":\"0xFFFFF96000000000\",\"image_size\":\"2.1 MB\",\"flags\":\"0x0\",\"index\":12,\"path\":\"C:/Windows/System32/win32k.sys\",\"is_trusted\":true},"
            "{\"name\":\"ndis.sys\",\"base_address\":\"0xFFFFF88001A00000\",\"image_size\":\"1.3 MB\",\"flags\":\"0x0\",\"index\":24,\"path\":\"C:/Windows/System32/drivers/ndis.sys\",\"is_trusted\":true}"
            "],"
            "\"process_memory\":["
            "{\"name\":\"chrome.exe\",\"pid\":5678,\"private_mb\":256,\"working_set_mb\":312,\"virtual_mb\":1024,\"suspicious_inject\":false},"
            "{\"name\":\"svchost32.exe\",\"pid\":9012,\"private_mb\":96,\"working_set_mb\":128,\"virtual_mb\":256,\"suspicious_inject\":true},"
            "{\"name\":\"explorer.exe\",\"pid\":1234,\"private_mb\":48,\"working_set_mb\":72,\"virtual_mb\":512,\"suspicious_inject\":false},"
            "{\"name\":\"wuauclt32.exe\",\"pid\":3456,\"private_mb\":128,\"working_set_mb\":156,\"virtual_mb\":384,\"suspicious_inject\":false},"
            "{\"name\":\"svchost.exe\",\"pid\":876,\"private_mb\":32,\"working_set_mb\":48,\"virtual_mb\":256,\"suspicious_inject\":false}"
            "]}";
        data = QJsonDocument::fromJson(jsonStr.toUtf8()).object();
    }
...
void MemoryImagePage::populateMemoryStatus(const QJsonObject &data)
{
    ...
    int total = data.value("total_physical_mb").toInt(16384);
    int used  = data.value("used_physical_mb").toInt(6348);
    double pct = data.value("used_percent").toDouble(38.7);
    int avail = data.value("available_physical_mb").toInt(10036);
    int virt  = data.value("virtual_memory_mb").toInt(32768);
    QString pf = data.value("page_file").toString("C:\\pagefile.sys (2048 MB)");
...
void MemoryImagePage::populateProcessMemory(const QJsonObject &data)
{
    ...
    for (const QJsonValue &v : procs) {
        ...
        // suspicious_inject: true=注入, false=无, null/missing=可疑
